...
### vite.config.js
Конфигурация Vite для разработки, запускает dev-сервер на порту 3000.

### vite.userscript.config.js
Конфигурация Vite для сборки Tampermonkey-скрипта, создает единый бандл в dist/ с Tampermonkey заголовками.
